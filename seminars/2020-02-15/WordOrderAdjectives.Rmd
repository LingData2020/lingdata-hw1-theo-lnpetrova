...
Correlations for multiple variables (dataframe), [cource](https://www.r-bloggers.com/spearman-correlation-heat-map-with-correlation-coefficients-and-significance-levels-in-r/)
```{r}
# library(Hmisc)
# library(reshape2)
